...
- `fah-owner/index.html` คือหน้าร้านสำหรับเจ้าของร้าน
...
Closed legacy routes: /b/{shopSlug}, /book/{shopSlug}, /o/{shopSlug}, /dashboard/{shopSlug}; /owner.html redirects to /fah-owner/
```
...
- Route เก่า `/b/:shopSlug`, `/o/:shopSlug`, `/book/:shopSlug`, และ `/dashboard/:shopSlug` ถูกปิดใน `_redirects`, dev server, และ service worker แล้ว
- Route เก่า `/owner.html` redirect ไป canonical route `/fah-owner/`
